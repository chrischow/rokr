...
export default function SurveyForm() {
  ...
  const [surveyFormValues, setSurveyFormValues] = useState<ISurveyForm>({
    lookAndFeel: 0,
    easeOfUse: 0,
    meetNeeds: 0,
    likeMost: '',
  ...
  const questions = [
    {
      qnKey: 'lookAndFeel',
      qnText: 'How would you rate the look and feel of the app?'
    },
    {
      qnKey: 'easeOfUse',
      qnText: 'How would you rate the ease of use of the app?'
    },
    {
      qnKey: 'meetNeeds',
      qnText: 'Does the app meet your needs?'
    },
    {
      qnKey: 'likeMost',
      qnText: 'What do you like most about the app and why?'
    },
    {
      qnKey: 'likeLeast',
      qnText: 'What do you like least about the app and why?'
    },
    {
      qnKey: 'suggestions',
      qnText: 'What would you suggest we do to improve the app?'
    },
    {
      qnKey: 'overall',
      qnText: 'What is your overall satisfaction with the app?'
    }
  ];
                          ...
                          <span
                            ...
                            onMouseLeave={() => {
                              setHoverState(prevData => {
                                return {
                                  ...prevData,
                                  [question.qnKey]: surveyFormValues[question.qnKey as keyof ISurveyForm]
                                };
                              })
                            }}
                          >
                ...
                {question.qnKey === 'overall' &&
                  <Carousel.Caption>
                    <span className="text-grey">
                      You'll get to check your response on the next page.
                    </span>
                  </Carousel.Caption>
                }
              </Carousel.Item>
            ...
            <Row className="justify-content-center">
              {
                questions.map((question: IQuestion, qnIndex: number) => {
                  ...
                  const responseValue = surveyFormValues[qnKey as keyof typeof hoverState];
                  let textTitle;
                  if (qnKey === 'likeMost') {
                  ...
                  return (
                    <Col xs={6}>
                      <div className="survey-check-title mt-3">
                      ...
                      {[3, 4, 5].includes(qnIndex) && responseValue &&
                        ...
                        >
                          <span className="text-green survey-check-text">Your response</span>
                        </OverlayTrigger>
                      }
                    </Col>
                  );
