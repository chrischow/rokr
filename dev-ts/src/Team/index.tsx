          ...
          <div className="mt-4">
            <Tab.Content>
              <Tab.Pane eventKey="monthly">
                {objectives.isSuccess && keyResults.isSuccess && staffList &&
                  <TeamPane
                    teamName={props.team.teamName}
                    freq="monthly"
                    subgroups={subgroups ? subgroups['monthly'] : new Array('')}
              ...
              <Tab.Pane eventKey="quarterly">
                {objectives.isSuccess && keyResults.isSuccess &&
                  <TeamPane
                    teamName={props.team.teamName}
                    freq="quarterly"
                    subgroups={subgroups ? subgroups['quarterly'] : new Array('')}
                    objectives={objectives.data}
                    keyResults={keyResults.data}
                  />
                }
              ...
              <Tab.Pane eventKey="annual">
                {objectives.isSuccess && keyResults.isSuccess && 
                  <TeamPane
                    teamName={props.team.teamName}
                    freq="annual"
                    subgroups={subgroups ? subgroups['annual'] : new Array('')}
                    objectives={objectives.data}
                    keyResults={keyResults.data}
                  />
                }
